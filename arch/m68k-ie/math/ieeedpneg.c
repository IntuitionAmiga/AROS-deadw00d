/*
    ...
    Desc: IE arch-specific IEEE DP negate — GCC softfloat override
*/

#include <aros/libcall.h>

/*
 * IEEEDPNeg — IEEE double-precision negate.
 *
 ...
 */
AROS_LH1(double, IEEEDPNeg,
    AROS_LHA(double, a, D0),
    struct Library *, MathIeeeDoubBasBase, 10, MathIeeeDoubBas)
{
    AROS_LIBFUNC_INIT
